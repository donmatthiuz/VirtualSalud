	...
	<body>
		<div class="main-page-wrapper">
							...
							<a href="https://wa.me/50256867313" target="_blank" style="text-decoration: none; color: inherit;">
								<div style="display: flex; align-items: center; gap: 10px;">
									...
									<div>
										...
										<p style="margin: 0;">(+502) 47305574</p>
									</div>
								</div>
							</a>
						</li>
			...
			<div class="theme-inner-banner section-spacing">
				<div class="overlay">
					<div class="container">
						<h2>Cuidado Profesional de Salud en el Hogar</h2>
					</div> <!-- /.container -->
				</div> <!-- /.overlay -->
			...
			<div class="our-blog section-spacing">
				<div class="professional-blog-container">
					...
					<div class="blog-header">
						<h1>Transformando el Cuidado de la Salud en Guatemala</h1>
						<div class="blog-meta">
							<div class="meta-item">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xl-4 col-lg-3 col-sm-6 footer-recent-post">
								<h6 class="title">ARTÍCULOS RECIENTES</h6>
								<ul>
									<li class="clearfix">
										<img src="images/blog/1.jpg" alt="Blog post" class="float-left">
										<div class="post float-left">
											<a href="blog-details.php">Cuidado profesional de salud en el hogar.</a>
											<div class="date"><i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo date('M d, Y'); ?></div>
										</div>
									</li>
									<li class="clearfix">
										<img src="images/blog/2.jpg" alt="Blog post" class="float-left">
										<div class="post float-left">
											<a href="blog-details.php">Beneficios del cuidado domiciliar.</a>
											<div class="date"><i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo date('M d, Y', strtotime('-5 days')); ?></div>
										</div>
									</li>
								</ul>
