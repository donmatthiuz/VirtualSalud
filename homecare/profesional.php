...
// Set page title
$page_title = "Enfermera Profesional";
?>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="callout-banner no-bg">
				<div class="container clearfix">
					<h3 class="title">¿ Que Ofrecen  <br> Las Enfermeras Profesionales ?</br></h3>
					<p>la enfermera profesional tiene un nivel de responsabilidad y conocimiento más amplio, lo cual es clave en situaciones médicas más delicadas o que requieren intervenciones técnicas. Para coordinar atención profesional en casa, contáctanos </p>
						...
						<div class="row">
							<div class="col-lg-6 col-12 text order-lg-last">
								<div class="theme-title-one">
									<h2>Tareas de una Enfermera Profesional</h2>
								</div> <!-- /.theme-title-one -->
								<p>   La enfermera profesional tiene un nivel de responsabilidad y conocimiento más amplio, lo cual es clave en situaciones médicas más delicadas o que requieren intervenciones técnicas. Para coordinar atención profesional en casa, contáctanos: <a href=https://wa.me/50256867313>aqui</a></p>
			...
			<div class="feature-banner section-spacing">
				<div class="opacity">
					<div class="container">
						<h2>¿ Necesitas una profesional ? </h2>
