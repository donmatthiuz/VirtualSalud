					...
					<div class="container">
						<div class="row">
							<div class="col-lg-6 col-12 text order-lg-last">
								...
								<img src="images/home/sign-black.png" alt="Signature" class="sign">
							</div> <!-- /.col- -->
							<div class="col-lg-6 col-12 order-lg-first">
								<img src="images/home/15.jpg" alt="About us" class="left-img">
							</div>
						</div> <!-- /.row -->
					</div> <!-- /.container -->
				</div> <!-- /.overlay -->
							...
							<div class="col-lg-6 col-12 order-lg-first">
								<ul class="best-list-item">
									<li>
										...
										<h5><a href="service-details.php">Best Strategy</a></h5>
									...
									<li>
										...
										<h5><a href="service-details.php">High-Quality Services</a></h5>
										<p>The Love Boat soon will be making another run plore strange tools enter new worlds.</p>
									</li>
									<li>
										<i class="icon flaticon-people"></i>
										<h5><a href="service-details.php">Friendly Support</a></h5>
										<p>The Love Boat soon will be making another run plore strange tools enter new worlds.</p>
									</li>
								</ul>
							</div> <!-- /.col- -->
						...
						<div class="core-value-slider">
							<div class="item">
								<div class="single-value-block">
									<div class="image-box">
										<img src="images/home/17.jpg" alt="Challenging Staff">
										<div class="overlay"><a href="service-details.php" class="theme-button-one">READ MORE</a></div>
									</div> <!-- /.image-box -->
									<div class="text">
										<h5><a href="service-details.php">Challenging Staff</a></h5>
							...
							<div class="item">
								<div class="single-value-block">
									<div class="image-box">
										<img src="images/home/18.jpg" alt="Integrity Properties">
										<div class="overlay"><a href="service-details.php" class="theme-button-one">READ MORE</a></div>
									</div> <!-- /.image-box -->
									<div class="text">
										<h5><a href="service-details.php">Integrity Properties</a></h5>
										<p>The Love Boat soon will be making other run plore strange tools.</p>
									</div> <!-- /.text -->
								</div> <!-- /.single-value-block -->
							</div> <!-- /.col- -->
							<div class="item">
								<div class="single-value-block">
									<div class="image-box">
										<img src="images/home/19.jpg" alt="Innovation Solutions">
										<div class="overlay"><a href="service-details.php" class="theme-button-one">READ MORE</a></div>
									</div> <!-- /.image-box -->
									<div class="text">
										<h5><a href="service-details.php">Innovation Solutions</a></h5>
										<p>The Love Boat soon will be making other run plore strange tools.</p>
									</div> <!-- /.text -->
								</div> <!-- /.single-value-block -->
							</div> <!-- /.col- -->
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-8 col-12">
							<div class="partner-slider">
								<div class="item"><img src="images/logo/p-1.png" alt="Partner 1"></div>
								<div class="item"><img src="images/logo/p-2.png" alt="Partner 2"></div>
								<div class="item"><img src="images/logo/p-3.png" alt="Partner 3"></div>
								<div class="item"><img src="images/logo/p-4.png" alt="Partner 4"></div>
								<div class="item"><img src="images/logo/p-5.png" alt="Partner 5"></div>
							</div>
						</div>
					</div>
				</div>
