...
BASE_URL = "http://localhost/homecare/"  # Cambia esto a tu dominio real
...
def generar_page_sitemap():
    urls = []
    exclude_dirs = {"blogs", "vendor", "__pycache__", "output", ".git", ".venv", "phphtml", "PHPMailer", "PMIAL"}
    exclude_files = {"generate_sitemap.py", "config.php"}  # si aplica
