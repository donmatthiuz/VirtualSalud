	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="callout-banner no-bg">
				<div class="container clearfix">
					<h3 class="title">¿ Que Ofrecen  <br> Las Cuidadoras ?</br></h3>
					<p>Una Cuidadora de Salud es una persona capacitada para brindar apoyo no clínico pero esencial a pacientes en su hogar. Su labor se centra en el acompañamiento, la asistencia en actividades básicas como alimentación, higiene personal, movilidad y supervisión general del bienestar del paciente. Este servicio está pensado para personas mayores, pacientes en recuperación o con condiciones crónicas que requieren compañía y cuidado constante en un ambiente familiar y seguro.</p>
						...
						<div class="row">
							<div class="col-lg-6 col-12 text order-lg-last">
								<div class="theme-title-one">
									<h2>Tareas de una Cuidadora</h2>
								</div> <!-- /.theme-title-one -->
								<p> la Cuidadora no realiza procedimientos médicos ni administra tratamientos. Su enfoque es más humano y asistencial, ideal para quienes necesitan apoyo diario sin intervención clínica. Si deseas contratar este servicio para ti o un ser querido, comunícate con nosotros por WhatsApp  <a href=https://wa.me/50256867313>aqui</a></p>
