...
<html lang="en">
	<head>
		...
		<title>Blog Grid - <?php echo $site_name; ?></title>
		<!-- Favicon -->
					...
					<div class="row">
						<div class="col-xl-9 col-lg-8 col-12 our-blog">
							<div class="post-wrapper row">
								<div class="col-md-6 col-12">
									<div class="single-blog">
										...
										<div class="post-meta">
											<h5 class="title"><a href="blog-details.php">Trouble with the law since</a></h5>
								...
								<div class="col-md-6 col-12">
									<div class="single-blog">
										...
										<div class="post-meta">
											<h5 class="title"><a href="blog-details.php">Kind of torture to have to watch</a></h5>
											<p>To seek out new life and new civilizations to boldly go where no man has gone before you would see the biggest gift.</p>
											<a href="blog-details.php" class="read-more">READ MORE</a>
										</div> <!-- /.post-meta -->
									</div> <!-- /.single-blog -->
								...
								<div class="col-md-6 col-12">
									<div class="single-blog">
										...
										<div class="post-meta">
											<h5 class="title"><a href="blog-details.php">Make the best of things its an uphill.</a></h5>
											<p>To seek out new life and new civilizations to boldly go where no man has gone before you would see the biggest gift.</p>
											<a href="blog-details.php" class="read-more">READ MORE</a>
										</div> <!-- /.post-meta -->
									</div> <!-- /.single-blog -->
							...
							<div class="theme-pagination">
								<ul>
									<li><a href="#" rel="noopener noreferrer">1</a></li>
									<li class="active"><a href="#" rel="noopener noreferrer">2</a></li>
									<li><a href="#" rel="noopener noreferrer"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
								</ul>
							</div>
						</div>
						<!-- ===================== Blog Sidebar ==================== -->
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-8 col-12 blog-sidebar">
							<div class="sidebar-container sidebar-search">
								<form action="search.php" method="POST">
									<input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
									<input type="text" name="search_query" placeholder="Search..." maxlength="100" required>
							...
							<div class="sidebar-container sidebar-recent-post">
								...
								<ul>
									<li class="clearfix">
										<img src="images/blog/6.jpg" alt="Recent Post" class="float-left">
									...
									<li class="clearfix">
										<img src="images/blog/7.jpg" alt="Recent Post" class="float-left">
										<div class="post float-left">
									...
									<li class="clearfix">
										<img src="images/blog/8.jpg" alt="Recent Post" class="float-left">
										<div class="post float-left">
											<a href="blog-details.php">World don't move to beat of just one drum.</a>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xl-4 col-lg-3 col-sm-6 footer-recent-post">
								...
								<ul>
									<li class="clearfix">
										<img src="images/blog/1.jpg" alt="Recent Post" class="float-left">
										<div class="post float-left">
									...
									<li class="clearfix">
										<img src="images/blog/2.jpg" alt="Recent Post" class="float-left">
										<div class="post float-left">
											<a href="blog-details.php">World don't move to beat of just one drum.</a>
