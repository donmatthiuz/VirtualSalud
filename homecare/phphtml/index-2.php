	...
	<body>
		<div class="main-page-wrapper">
			...
			<div id="theme-main-banner" class="banner-one">
				<div data-src="<?php echo $site_url; ?>/images/home/slide-5.jpg">
					<div class="camera_caption">
						<div class="container">
							...
							<a href="<?php echo $site_url; ?>/about.php" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s">ABOUT US</a>
						</div> <!-- /.container -->
					</div> <!-- /.camera_caption -->
				</div>
						...
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									<img src="<?php echo $site_url; ?>/images/icon/5.png" alt="" class="icon">
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									<img src="<?php echo $site_url; ?>/images/icon/6.png" alt="" class="icon">
									<h5><a href="service-details.html">Business Services</a></h5>
									<p>The explore strange new worlds to seek fout new life and new civilizations to boldly where no man has before gone. </p>
								</div> <!-- /.single-solution-block -->
							</div> <!-- /.col- -->
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									<img src="<?php echo $site_url; ?>/images/icon/7.png" alt="" class="icon">
									<h5><a href="service-details.html">Business Services</a></h5>
									<p>The explore strange new worlds to seek fout new life and new civilizations to boldly where no man has before gone. </p>
								</div> <!-- /.single-solution-block -->
							</div> <!-- /.col- -->
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									<img src="<?php echo $site_url; ?>/images/icon/8.png" alt="" class="icon">
									<h5><a href="service-details.html">Business Services</a></h5>
									<p>The explore strange new worlds to seek fout new life and new civilizations to boldly where no man has before gone. </p>
								</div> <!-- /.single-solution-block -->
							</div> <!-- /.col- -->
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									<img src="<?php echo $site_url; ?>/images/icon/9.png" alt="" class="icon">
									<h5><a href="service-details.html">Business Services</a></h5>
									<p>The explore strange new worlds to seek fout new life and new civilizations to boldly where no man has before gone. </p>
								</div> <!-- /.single-solution-block -->
							</div> <!-- /.col- -->
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									<img src="<?php echo $site_url; ?>/images/icon/10.png" alt="" class="icon">
									<h5><a href="service-details.html">Business Services</a></h5>
									<p>The explore strange new worlds to seek fout new life and new civilizations to boldly where no man has before gone. </p>
								</div> <!-- /.single-solution-block -->
							</div> <!-- /.col- -->
					...
					<div class="container">
						<div class="row no-gutters">
							<div class="col-lg-7 col-12 text">
								...
								<img src="<?php echo $site_url; ?>/images/home/sign.png" alt="" class="sign">
							</div> <!-- /.col- -->
						...
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									<img src="<?php echo $site_url; ?>/images/portfolio/1.jpg" alt="">
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									<img src="<?php echo $site_url; ?>/images/portfolio/2.jpg" alt="">
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Business Meeting</a></h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									<img src="<?php echo $site_url; ?>/images/portfolio/3.jpg" alt="">
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Business Meeting</a></h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									<img src="<?php echo $site_url; ?>/images/portfolio/4.jpg" alt="">
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Business Meeting</a></h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									<img src="<?php echo $site_url; ?>/images/portfolio/5.jpg" alt="">
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Business Meeting</a></h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-case-block">
									<img src="<?php echo $site_url; ?>/images/portfolio/6.jpg" alt="">
									<div class="hover-content">
										<div class="text clearfix">
											<div class="float-left">
												<h5><a href="project-details.html">Business Meeting</a></h5>
							...
							<div class="latest-news-slider">
								<div class="item">
									<div class="single-blog">
										<div class="image-box">
											<img src="<?php echo $site_url; ?>/images/blog/3.jpg" alt="">
								...
								<div class="item">
									<div class="single-blog">
										<div class="image-box">
											<img src="<?php echo $site_url; ?>/images/blog/4.jpg" alt="">
								...
								<div class="item">
									<div class="single-blog">
										<div class="image-box">
											<img src="<?php echo $site_url; ?>/images/blog/5.jpg" alt="">
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-12 logo-widget">
								<div class="logo"><a href="<?php echo $site_url; ?>"><img src="<?php echo $site_url; ?>/images/logo/logo2.png" alt=""></a></div>
							...
							<div class="col-lg-2 col-sm-6 col-12 footer-list">
								...
								<ul>
									<li><a href="<?php echo $site_url; ?>/about.php">About us</a></li>
									<li><a href="<?php echo $site_url; ?>/services.php">Our Solutions</a></li>
							...
							<div class="col-lg-3 col-sm-6 col-12 footer-gallery">
								...
								<div class="wrapper">
									<div class="row">
										<div class="col-4">
											<a href="images/portfolio/7.jpg" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="<?php echo $site_url; ?>/images/portfolio/7.jpg" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/portfolio/8.jpg" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="<?php echo $site_url; ?>/images/portfolio/8.jpg" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/portfolio/9.jpg" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="<?php echo $site_url; ?>/images/portfolio/9.jpg" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/portfolio/10.jpg" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="<?php echo $site_url; ?>/images/portfolio/10.jpg" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/portfolio/11.jpg" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="<?php echo $site_url; ?>/images/portfolio/11.jpg" alt=""></a>
										</div>
										<div class="col-4">
											<a href="images/portfolio/12.jpg" data-fancybox="gallery" data-caption="Caption for single image" class="fancybox"><img src="<?php echo $site_url; ?>/images/portfolio/12.jpg" alt=""></a>
										</div>
									</div>
								</div>
							</div> <!-- /.footer-gallery -->
		...
		<!-- Language Stitcher -->
		<script src="<?php echo $site_url; ?>/vendor/language-switcher/jquery.polyglot.language.switcher.js"></script>
		<!-- Google map js -->
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjQLCCbRKFhsr8BY78g2PQ0_bTyrm_YXU"></script>
		<script src="<?php echo $site_url; ?>/vendor/sanzzy-map/dist/snazzy-info-window.min.js"></script>

		<!-- Theme js -->
		<script src="<?php echo $site_url; ?>/js/theme.js"></script>
		<script src="<?php echo $site_url; ?>/js/map-script.js"></script>
