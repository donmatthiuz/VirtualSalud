...
<html lang="es">
	...
	<body>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xl-8 col-lg-7 col-md-6 col-12 order-md-first image-col">
							<img src="<?php echo $site_url; ?>/images/portfolio/16.jpg" alt="">
							<img src="<?php echo $site_url; ?>/images/portfolio/17.jpg" alt="">
							<img src="<?php echo $site_url; ?>/images/portfolio/18.jpg" alt="">
						</div>
					</div> <!-- /.row -->
				</div> <!-- /.container -->
			</div> <!-- /.project-details -->
		...
		<!-- Canvas Js -->
		<script src="<?php echo $site_url; ?>/vendor/jquery.canvasjs.min.js"></script>
