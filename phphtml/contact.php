...
<html lang="es">
	...
	<body>
							...
							<!-- ============== Menu Warpper ================ -->
					   		<div class="menu-wrapper float-left">
								   ...
								   <ul class="clearfix">
									    ...
									    <li class="active"><a href="<?php echo $site_url; ?>/contact.php">contact</a></li>
								   </ul>
					...
					<div class="clearfix main-content no-gutters row">
						...
						<div class="col-lg-7 col-12">
							<div class="form-wrapper">
								<form action="inc/sendemail.php" class="theme-form-one form-validation" autocomplete="off" method="POST">
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
									<div class="row">
										<div class="col-sm-6 col-12"><input type="text" placeholder="Name *" name="name" maxlength="100"></div>
										<div class="col-sm-6 col-12"><input type="text" placeholder="Phone *" name="phone" maxlength="100"></div>
										<div class="col-sm-6 col-12"><input type="email" placeholder="Email *" name="email" maxlength="100"></div>
										<div class="col-sm-6 col-12"><input type="text" placeholder="Website *" name="web" maxlength="100"></div>
		...
		<!-- Validation -->
		<script type="text/javascript" src="<?php echo $site_url; ?>/vendor/contact-form/validate.js"></script>
		<script type="text/javascript" src="<?php echo $site_url; ?>/vendor/contact-form/jquery.form.js"></script>
		<!-- Google map js -->
