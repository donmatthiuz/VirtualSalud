...
// Configurar código de respuesta HTTP 404
http_response_code(404);

// Procesar búsqueda si se envía
$search_query = '';
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['search'])) {
    ...
    if (!empty($search_query)) {
        header('Location: ' . $site_url . '/search.php?q=' . urlencode($search_query));
        exit;
    }
}
?>
	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="container error-page">
				...
				<div>
					<a href="<?php echo $site_url; ?>" class="theme-button-one">Go Home</a>
