		...
		<div class="main-page-wrapper">
			...
			<div class="callout-banner no-bg">
				<div class="container clearfix">
					...
					<a href="#" class="theme-button-one" rel="noopener noreferrer">CONTACT US</a>
				</div>
			</div> <!-- /.callout-banner -->
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-6 col-12 text order-lg-last">
								...
								<img src="<?php echo $site_url; ?>/images/home/sign-black.png" alt="" class="sign">
							</div> <!-- /.col- -->
							<div class="col-lg-6 col-12 order-lg-first">
								<img src="<?php echo $site_url; ?>/images/home/15.jpg" alt="" class="left-img">
							</div>
						</div> <!-- /.row -->
					</div> <!-- /.container -->
				</div> <!-- /.overlay -->
						...
						<div class="core-value-slider">
							<div class="item">
								<div class="single-value-block">
									<div class="image-box">
										<img src="<?php echo $site_url; ?>/images/home/17.jpg" alt="">
										<div class="overlay"><a href="#" class="theme-button-one" rel="noopener noreferrer">READ MORE</a></div>
									</div> <!-- /.image-box -->
									<div class="text">
										<h5><a href="#" rel="noopener noreferrer">Challenging Staff</a></h5>
							...
							<div class="item">
								<div class="single-value-block">
									<div class="image-box">
										<img src="<?php echo $site_url; ?>/images/home/18.jpg" alt="">
										<div class="overlay"><a href="#" class="theme-button-one" rel="noopener noreferrer">READ MORE</a></div>
									</div> <!-- /.image-box -->
									<div class="text">
										<h5><a href="#" rel="noopener noreferrer">Integrity Properties</a></h5>
										<p>The Love Boat soon will be making other run plore strange tools.</p>
									</div> <!-- /.text -->
								</div> <!-- /.single-value-block -->
							</div> <!-- /.col- -->
							<div class="item">
								<div class="single-value-block">
									<div class="image-box">
										<img src="<?php echo $site_url; ?>/images/home/19.jpg" alt="">
										<div class="overlay"><a href="#" class="theme-button-one" rel="noopener noreferrer">READ MORE</a></div>
									</div> <!-- /.image-box -->
									<div class="text">
										<h5><a href="#" rel="noopener noreferrer">Innovation Solutions</a></h5>
										<p>The Love Boat soon will be making other run plore strange tools.</p>
									</div> <!-- /.text -->
								</div> <!-- /.single-value-block -->
							</div> <!-- /.col- -->
